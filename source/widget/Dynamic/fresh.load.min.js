...
$(function(){
	...
	//动态大小图片切换功能
    $('.fresh-list').off('click', '.fresh-type-img div').on('click', '.fresh-type-img div', function(){
    ...
    // 点击动态试题图片切换方法
    $('.fresh-list').off('click', '.fresh-type-answer .fresh-media-small-img').on('click', '.fresh-type-answer .fresh-media-small-img', function(e){
        var that = $(this).closest('.fresh-type-answer');
        fresh.media.answer.imgToggle(that, e);
    });

    $('.fresh-list').off('click', '.fresh-big-img-answer').on('click', '.fresh-big-img-answer', function(e){
    ...
    // 点击表情按钮,弹出表情弹出层
    $('.fresh-list').off('click', '.fresh-comment-emote-smiles-btn').on('click', '.fresh-comment-emote-smiles-btn', function(event){
    ...
    //点击添加关注按钮
    $('.fresh-list').off('click', '.fresh-course-attention .fresh-add-attention-btn').on('click', '.fresh-course-attention .fresh-add-attention-btn', function(){
        var that = $(this).closest('.fresh-course-attention');
        fresh.attention.addCancel(that);
    })

    //点击添加取消关注按钮
    $('.fresh-list').off('click', '.fresh-course-attention .fresh-add-cancel-btn').on('click', '.fresh-course-attention .fresh-add-cancel-btn', function(){
        var that = $(this).closest('.fresh-course-attention');
        fresh.attention.addCancel(that);
    })
