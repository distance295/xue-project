...
<div class="scroll-box-wrap">
    <div class="scroll-box-nav">
        ...
        <div class="scroll-btn">
            ...
            <span><a href="#" class="btn btn-danger">立即报名</a></span>
        </div>
    </div>
</div>
<div class="course-info-box">
    <div class="course-detail" style="display:block;">
        <table class="table table_outline">
            <tbody>
                ...
                <tr>
                    <td class="t-left">
                        <span class="live_teach">[直播辅导]</span> 计算机爱空间上的课教案和时间肯
                    </td>
                    <td>7月1好</td>
                    <td>17:00-19:00</td>
                    <td>
    ...
    <div class="course-detail">
        <dl>
            <dt>课程有效期</dt>
            <dd>
                本课程有效期自购买之日开始计算，请于 <font color="red">2015-08-31</font> 学完，合理安排学习时间。
            </dd>
        </dl>
        <dl>
            <dt>课程更新时间</dt>
    ...
    <div class="course-detail">
        ...
        <div class="ui-comment-items">
            ...
            <div class="Extend_add_gold" style="opacity: 1; bottom: -7px; display: block;">
                <p><strong>1</strong></p>
            </div>
        </div>
        <!-- 评论发表框 end-->
