...
<div class="ui-course-infor-wrap">
    	<h2 class="coures-name-title">人教人教人教版四升五年级上下全册数学满分班<em>目标满分班</em></h2>
...
<!--多个老师头像左右切换-->
            ...
            <div class="course-content-text">
				...
				<ul class="f-left">
					<li><a href="#" target="_blank">20讲视频课程</a><a href="#" target="_blank">2场直播辅导</a></li>
				</ul>
			</div>
           ...
           <span class="f-left">
			...
			<span class="f-left">
				<button class="btn btn-danger button_shop-cart" data-id="110001" data-loading-text="已加入购物车" autocomplete="off">加入购物车</button>
			</span>
...
<script>
  $('.button_shop-cart').on('click', function () {
