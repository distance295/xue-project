<!--
    @require ui-trends.less
-->
<div class="ui-index-trends glory-grades-list">
	<div class="index-new-trends">
		...
		<div class="index-login-items">
			<div class="media">
				...
				<div class="media-body">
					...
					<div class="user-info">
						<span class="user-sex badge"> <i class="fa fa-venus fa-mars"></i>
						</span>
					...
					<strong>322367</strong>
					个家庭选择网校
					<br/>
					<strong>127585</strong>
					节视频课程
					<br/>
					<strong>免费</strong>
					学习课程
