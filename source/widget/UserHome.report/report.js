 $(function(){
    ...
    if($('#pieData').val()){
        ...
        if(json.process==1){
            ...
            drawPie();
            $('.section-2 .process').eq(0).css({right:"55%",top:7})
            ...
            $('.section-2 .process').eq(1).css({right:'65%',top:7})
        ...
        $('.section-6 img,.section-7 img').css({height:$('body').height()*0.3})
       ...
       function drawPie(flag){
            ...
            for(var i=0;i<data.length;i++){
                ...
                draw(cxt,w/2,h/2,(r+50)>(w/2-5)?r:r+50,(startDeg+1)*deg,(startDeg+iDeg)*deg,iDeg,data[i].name,color[i]);
                startDeg+=iDeg;
            }
            cxt.closePath()
        }
