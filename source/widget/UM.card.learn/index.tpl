     ...
     <div class="contentbind">
         <div class="cl-learn">
             <div class="cl-content">
                 ...
                 <div class="cl-content-right">
                     ...
                     <span class="btn-pay btn btn-info">充值</span>
                     <a href="">查看充值记录</a>
                 </div>
             </div>
             <div class="prompt-box">
                 ...
                 <div class="cl-prompt-box">
                     <h3>提示</h3>
                     <p>
                         1. 您可以拨打客服热线：<strong>400-800-2211</strong>购买学习卡进行充值，我们会通过快递的方式将学习卡送到您的手中。
                         <br/>
         ...
         <div class="cl-bank">
             <div class="cl-input">
                 ...
                 <span class="cl-btn btn btn-info">下一步</span>
             </div>
             <div class="payment_bank">
                 ...
                 <div class="formPastPayment">
                    <span class="cl-btn btn btn-info" type="button">去充值</span>
                 </div>
             </div>
