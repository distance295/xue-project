...
<div class="notice-warp">
        <div class="notice-message row">
            <div class="notice-user col-sm-1">
                <a><img src="img/notice-user.jpg"></a>
                <span>教师</span>
            </div>
        ...
        <div class="notice-message row">
            ...
            <div class="notice-text col-sm-11">
                <p>景雪京同学： 直播邀请,2015-09-11 10:45:00至2015-09-11 11:45:00，进行直播答疑,直播主题：这次一定要成功</p>
                <span>11小时前</span>
            </div>
        </div>
        <div class="notice-message row">
