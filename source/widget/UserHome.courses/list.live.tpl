...
<div class="courselayout-list courseList-wrap">
    ...
    <div class="course-table-live-title course-table-title">
        <span class="span-w1">名称</span>
        <span class="span-w2">名称</span>
        <span class="span-w3">状态</span>
        <span class="span-w4">操作</span>
    </div>
    <ul class="table course-table course-live-table">
            <li>
