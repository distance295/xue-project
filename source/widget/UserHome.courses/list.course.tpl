                    ...
                    <div class="more-service left">
                        ...
                        <div class="hide drop-course-detail">
                            <div class="drop-course-detail-inner">
                                ...
                                <p class="drop-course-btn-wrap"><a href="###" class="drop-course-btn ajust-course-btn">确定退课</a></p>
                            </div>
                        </div>
                        <!-- 临时调课 -->
                        <div class="hide temporary-adjust-course-detail">
                            <div class="temporary-adjust-course-detail-inner">
                                ...
                                <p>您还有<span>2</span>次临时调课机会。</p>
                                <p>当前上课时间：<span>每周六上午9:00-11:30</span></p>
                                <div class="adjust-course-select">
                                    <span>希望调整的场次：</span>
                                    <select>
                                ...
                                <p>已调场次：<span>第一次 记叙文的手型结构--开头</span></p>
                                <p class="ajusted-tips"><span>2月14号（周六）早9:00-11:30调至2月15号周日晚19:00-21:00</span></p>
                                <p class="drop-course-btn-wrap"><a href="###" class="drop-course-btn ajust-course-btn">确定调课</a></p>
                            </div>
                        </div>
                        <!-- 永久调课 -->
