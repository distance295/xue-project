...
<div class="courseList-wrap">
    <ul class="teacher-tab">
        ...
        <li data-url="/direct-courseList.html">直播</li>
        <li>录播</li>
        <li>已过期课程</li>
    </ul>
        ...
        <div class="courseList-body">
            <div class="left course-center">
                ...
                <p class="amount-show">
                    ...
                    <a class="small course-gray button course-btn" href="##">课程大纲</a>
                    <a class="small course-gray button course-btn last" href="##">
                        <label class="newLabel live-label">live</label>直播辅导</a>
